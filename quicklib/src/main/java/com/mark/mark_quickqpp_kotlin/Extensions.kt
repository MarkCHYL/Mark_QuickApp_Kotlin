package com.mark.mark_quickqpp_kotlin
...
import com.mark.mark_quickqpp_kotlin.base.MarkApplication
import com.mark.mark_quickqpp_kotlin.http.constant.CodeStatus
import com.mark.mark_quickqpp_kotlin.http.entity.BaseBean
import com.mark.mark_quickqpp_kotlin.scheduler.SchedulerUtils
import com.mark.mark_quickqpp_kotlin.utils.NetworkUtils
...
fun showToastBottom(@NotNull msg: String) {
    val sToast = Toast.makeText(MarkApplication.mContext, msg, Toast.LENGTH_SHORT)
    sToast.show()
}

fun showToastBottom(@StringRes msgResId: Int) {
    val sToast = Toast.makeText(MarkApplication.mContext, MarkApplication.mContext.resources.getString(msgResId), Toast.LENGTH_SHORT)
    sToast.show()
}
...
fun showToastCenter(@StringRes msgResId: Int) {
    val sToast = Toast.makeText(MarkApplication.mContext, MarkApplication.mContext.resources.getString(msgResId), Toast.LENGTH_SHORT)
    sToast.setGravity(Gravity.CENTER, 0, 0)
    sToast.setText(MarkApplication.mContext.resources.getString(msgResId))
    sToast.show()
    sToast.show()
}
